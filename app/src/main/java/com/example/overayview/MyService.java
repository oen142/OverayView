...
*/
        ...
        int random_fosition = random.nextInt(4);

        switch (random_fosition){

            case 0 : params.gravity = Gravity.LEFT | Gravity.TOP;
            break;
            case 1 : params.gravity = Gravity.RIGHT | Gravity.TOP;
                break;
            case 2 : params.gravity = Gravity.LEFT | Gravity.BOTTOM;
                break;
            case 3 : params.gravity = Gravity.RIGHT | Gravity.BOTTOM;
                break;
